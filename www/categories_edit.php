...
if (isset($btsubmit)) {
    ...
    if ($_id==0) 
        ...
        $sql="insert into categories values ('','$categorie')";
    else
        //maj d'un enregistrement
        $sql = "update categories set categorie='$categorie' where _id=$_id";
    ...
    if ($id > 0) {
        ...
        $sql = "select * from categories where _id=$id";
