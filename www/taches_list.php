...
<body>
    ...
    <main id="main">
        <h2>taches</h2>     
        <p><a href="taches_edit.php?id=0">Créer un enregistrement</a></p> 
        <table>
            <thead>
                <tr>
                    <?php
            ...
            foreach($data as $i => $ligne) {
                ...
                $id=$ligne["_id"];
                echo "<td><a href='taches_edit.php?id=$id'>modifier</a></td>";
                echo "<td><a href='taches_delete.php?id=$id'>supprimer</a></td>";
                echo "</tr>";
            }
            ?>
        </table>
