...
if (isset($btsubmit)) {
    ...
    if ($[prefixe]_id==0) 
        ...
        $sql = "update [table] set [listeChampsValeurs] where [prefixe]_id=$[prefixe]_id";
    ...
    if ($id > 0) {
        ...
        $sql = "select * from [table] where [prefixe]_id=$id";
...
<body>
    ...
    <main id="main">
        <h2>[table] : edition</h2>
        <form method="post">
            <input type="hidden" name="[prefixe]_id" value="<?= $[prefixe]_id ?>">
            <p>
                <label>[prefixe]_id</label> : <?= $[prefixe]_id ?>
            </p>
            [listeChampsInput]
            <p>
